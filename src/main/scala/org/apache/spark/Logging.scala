...
//import org.apache.spark.util.Utils.getSparkClassLoader
//import org.apache.spark.util.Utils.{getClass, getContextOrSparkClassLoader}
    ...
    if (usingLog4j12) {
      ...
      if (!log4j12Initialized) {
        ...
        if (isInInterpreter) {
          ...
          Option(getClass.getClassLoader.getResource(replDefaultLogProps)) match {
            case Some(url) =>
